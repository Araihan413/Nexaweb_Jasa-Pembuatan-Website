...
const Home = () => {
  useEffect(() => {
    document.title = "Beranda - Jasa Nexaweb";
  }, []);
  return (
    <>
        ...
        <main className='px-5 md:px-14 lg:px-24 bg-kotak-kotak'>
          <section id='home' className="pt-12 md:pt-40 lg:pt-10  -z-20 ">
            <div className="w-full h-full relative z-20 ">
              <div className="w-[20vh] h-[20vh] lg:w-[20vw] lg:h-[20vw] rounded-full bg-gradient-bubble1 blur-xl absolute top-1/4 left-0  -z-10"></div>
              <div className="w-[20vh] h-[20vh] lg:w-[20vw] lg:h-[20vw] rounded-full bg-gradient-bubble2 blur-xl absolute top-0 -right-16 -z-10"></div>
              <Heading></Heading>
            </div>
          </section>
          <section id='about'>
