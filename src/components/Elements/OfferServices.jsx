...
const OfferServices = (props) => {
  ...
  return (
    <>
      <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className={` rounded-2xl w-full lg:w-96 relative overflow-hidden  shadow-box-glass ${style}`}>
