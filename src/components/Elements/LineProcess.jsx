    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-9">
        <div className='order-2 md:order-1 col-span-1 md:col-span-4 md:flex md:justify-end items-center md:py-5 '>
          <motion.div variants={inView} whileInView="view" initial="hidden" className=" py-2 md:py-5 h-max flex  justify-center items-center md:bg-white/20 rounded-lg md:backdrop-blur w-full  max-w-96 md:shadow-box-glass">
        ...
        <div className="col-span-1 md:col-span-4 order-last py-5">
          ...
          <motion.div variants={inView} whileInView="view" initial="hidden" className={`bg-white/20 backdrop-blur rounded-lg md:shadow-box-glass p-4 ${style}`}>
