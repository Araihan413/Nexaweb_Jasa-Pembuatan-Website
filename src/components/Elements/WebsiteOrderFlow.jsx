  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-9">
      <div className={`col-span-1 order-3 md:col-span-4 ${order[0]} md:py-20 pb-5 flex justify-center items-center`}>
        <motion.div variants={fromButton} whileInView="isView" initial="isHidden" viewport={{ once: true }} className="rounded-lg p-4 bg-slate-200/20 backdrop-blur shadow-box-glass">
      ...
      <div className={`col-span-1 md:col-span-4 order-2 ${order[1]} flex justify-center items-center my-5`}>
        <motion.div variants={fromButton} whileInView="isView" initial="isHidden" viewport={{ once: true }} className=" py-2  flex flex-col items-center w-full ">
