...
const About = () => {
  return (
    <>
      <div>
        <div className="flex flex-col gap-10 md:gap-0 md:flex-row justify-between items-center relative mb-20 md:mb-36">
          <div>
          ...
          <figure className="w-80 h-80 md:absolute relative -top-3 -z-1 right-0">
